...
class SwekeyIntegration
{
	...
	function GetIntegrationScript()
	{
		...
		if (! empty($this->show_debug_info) || ! empty($_GET['swekey_debug_info']))
		{
			...
			<small><i>(To remove this text set "show_debug_info" to false in "my_integration.php" )</i></small><br>
			<br>
...
?>
			...
			Testing Ajax: <span id=swekey_ajax_result></span><br><br><br><br>
			</div>
			...
			else
			{
				...
				swekey_dir_url_res.appendChild(document.createTextNode("<?php echo $this->swekey_dir_url; ?>" + "swekey_integration.js not found please check '$this->swekey_dir_url' in 'my_integration.php'"));
			}
...
<?php
		...
		$output .= "<!-- PHP-Integration-Kit 2.0.4.5310 03/12/12 (emulation:$emul)-->\n";
